...
export const LaunchListDocument = gql`
  ...
  launches {
    ...
    `;
export type LaunchListComponentProps = Omit<ReactApollo.QueryProps<LaunchListQuery, LaunchListQueryVariables>, 'query'>;

    export const LaunchListComponent = (props: LaunchListComponentProps) => (
      <ReactApollo.Query<LaunchListQuery, LaunchListQueryVariables> query={LaunchListDocument} {...props} />
    );
    
export type LaunchListProps<TChildProps = {}> = Partial<ReactApollo.DataProps<LaunchListQuery, LaunchListQueryVariables>> & TChildProps;
export function withLaunchList<TProps, TChildProps = {}>(operationOptions?: ReactApollo.OperationOption<
  TProps,
  LaunchListQuery,
  LaunchListQueryVariables,
  LaunchListProps<TChildProps>>) {
    return ReactApollo.withQuery<TProps, LaunchListQuery, LaunchListQueryVariables, LaunchListProps<TChildProps>>(LaunchListDocument, {
      alias: 'withLaunchList',
      ...operationOptions
    });
};

    export function useLaunchListQuery(baseOptions?: ReactApolloHooks.QueryHookOptions<LaunchListQueryVariables>) {
      return ReactApolloHooks.useQuery<LaunchListQuery, LaunchListQueryVariables>(LaunchListDocument, baseOptions);
    };
...
export const LaunchProfileDocument = gql`
  ...
  launch(id: $id) {
    ...
    `;
export type LaunchProfileComponentProps = Omit<ReactApollo.QueryProps<LaunchProfileQuery, LaunchProfileQueryVariables>, 'query'> & ({ variables: LaunchProfileQueryVariables; skip?: false; } | { skip: true; });

    export const LaunchProfileComponent = (props: LaunchProfileComponentProps) => (
      <ReactApollo.Query<LaunchProfileQuery, LaunchProfileQueryVariables> query={LaunchProfileDocument} {...props} />
    );
    
export type LaunchProfileProps<TChildProps = {}> = Partial<ReactApollo.DataProps<LaunchProfileQuery, LaunchProfileQueryVariables>> & TChildProps;
export function withLaunchProfile<TProps, TChildProps = {}>(operationOptions?: ReactApollo.OperationOption<
  TProps,
  LaunchProfileQuery,
  LaunchProfileQueryVariables,
  LaunchProfileProps<TChildProps>>) {
    return ReactApollo.withQuery<TProps, LaunchProfileQuery, LaunchProfileQueryVariables, LaunchProfileProps<TChildProps>>(LaunchProfileDocument, {
      alias: 'withLaunchProfile',
      ...operationOptions
    });
};

    export function useLaunchProfileQuery(baseOptions?: ReactApolloHooks.QueryHookOptions<LaunchProfileQueryVariables>) {
      return ReactApolloHooks.useQuery<LaunchProfileQuery, LaunchProfileQueryVariables>(LaunchProfileDocument, baseOptions);
    };
